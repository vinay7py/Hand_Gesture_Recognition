...
as it starts recording. It takes 2000 images for the training set and 300 images for test_set.
...
dirs=['nothing/nothing','ok/ok','peace/peace','punch/punch','stop/stop','thumbs_up/thumbs_up']
sets={'training_set':5000,'test_set':1000}
