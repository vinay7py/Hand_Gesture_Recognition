...
histarray={'NOTHING':0,'OK':0,'PEACE':0, 'PUNCH':0, 'STOP': 0, 'Thumbs Up':0}
...
def realtime():
    ...
    classes=["nothing","ok","peace","punch","stop","thumbs_up"]
    ...
    while rval:
        ...
        histarray2={'NOTHING': y_pred[0][0], 'OK': y_pred[0][1], 'PEACE': y_pred[0][2], 'PUNCH': y_pred[0][3], 'STOP': y_pred[0][4], 'Thumbs Up': y_pred[0][5]}
        update(histarray2)
...
if model is not None:
    ...
    if ans.lower()=='y':
        ...
        def animate(i): 
            ...
            plt.xticks(np.arange(7), xtitles)
